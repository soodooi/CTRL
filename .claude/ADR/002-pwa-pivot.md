...
| P6 | AI 创作助手 (manifest generator) | depends P5 | UI now in PWA |
| P7 | WASM sandbox + 5 P0 built-in keycaps | depends P3.7 | keycap UI now in PWA |
| P8 | `ctrl-cloud` + ctrl-auth + ctrl-billing + **ctrl-push** | parallel P7 | +ctrl-push |
| P9 | ctrl-market + creator revenue share | depends P8 | manifest editor now in PWA |
| P10 | Closed beta | depends P7-P9 | unchanged |
...
bao to mark Status → Accepted upon review. Until then, no code changes; H-2026-05-13-001 (this handoff) is held in `proposed` state.
