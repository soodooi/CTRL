...
export const CodeSpaceRoute = (): ReactElement => {
  ...
  // Per memory `feedback_right_rail_is_fixed`: routes do NOT push items
  // into the right rail. Env switcher renders inside the code-space
  // route's own ClusterWorkspace sidebar (below).
