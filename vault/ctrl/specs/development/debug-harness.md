---
title: CTRL 自主调试 harness — 历史实施规格
kind: spec
created_at: 2026-07-04
owner: bao
author: claude
status: historical implementation snapshot; verify current state before reuse
purpose: 记录自主调试 harness 的历史分层方案与证据；当前开发要求以 `.kiro/steering/development-philosophy.md`、owning ADR 和仓库验证脚本为准。
...
> **非权威历史实施规格。** 本文不定义当前调试架构或验收门；当前 gate/transport 决定读 ADR-010，开发验证流程读 `vault/ctrl/development/dev-playbook.md` 与仓库脚本。
