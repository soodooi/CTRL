...
related:
  - vault/ctrl/adrs/002-substrate.md    # § composition (manifest), § mcp-bus, § subprocess
  - vault/ctrl/adrs/003-frontend.md      # §8 morphing surface (render parts / ui-registry)
  - vault/ctrl/adrs/006-cross-cutting.md # §5 business-system integration, §4 policy envelope, §3 plain-text
changelog:
