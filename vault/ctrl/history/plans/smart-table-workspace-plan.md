> **Status: Retired historical record.** Non-authoritative; this is not the current global plan. Current smart-table and frontend decisions live in ADR-002 and ADR-003.
