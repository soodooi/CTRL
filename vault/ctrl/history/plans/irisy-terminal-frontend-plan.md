...
source: 8-facet 全网调研(design 5 + 源码 3)一手来源;ACP 源码 Apache-2.0 已核实。见 [[../../research/terminal-frontend.md]] + ADR-005 §8.6.1/§8.6.2。
related:
...
> **Status: Retired historical record.** Non-authoritative; this is not an active frontend plan. Current Irisy and substrate boundaries live in ADR-005 and ADR-002.
