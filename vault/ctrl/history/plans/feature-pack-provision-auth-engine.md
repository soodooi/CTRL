...
status: retired
historical_scope: former ADR-002 provision proposal + manifest-schema.ts + kernel provision/auth runtime
related:
...
> **Status: Retired historical record.** Non-authoritative; this document does not govern provisioning or authentication. Current capability composition decisions live in ADR-002.
