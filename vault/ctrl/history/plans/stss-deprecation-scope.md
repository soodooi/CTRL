> **Status: Retired historical record.** Non-authoritative; this scope map no longer tracks active work. Current event-channel and substrate decisions live in ADR-002.

# ST-SS 弃用范围地图（历史 SC6 scoping）
