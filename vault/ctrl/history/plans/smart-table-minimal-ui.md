> **Status: Retired historical record.** Non-authoritative; current smart-table UI and storage decisions live in ADR-003 and ADR-002.
...
> governing ADR at the time = **ADR-003 §6 v20**。本文件仅保留历史 provenance。
