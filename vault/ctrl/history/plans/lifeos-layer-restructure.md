> **Status: Retired historical record.** Non-authoritative; this does not govern the current LifeOS or task surface. Current decisions live in ADR-002 and ADR-003.

# LifeOS layer 重构 — 历史规划图 + 竞品拆解 + Aino→CTRL 逐条映射
