> **Status: Retired historical record.** Non-authoritative; this design is provenance, not an active implementation contract. Current smart-table decisions live in ADR-002 and ADR-003.

# 智能表格关系型灵魂 — SQLite 派生索引历史设计
...
> 历史状态:设计曾待实施；现已退役，仅保留代码勘察 provenance。
