> **Status: Retired historical audit.** Non-authoritative; this issue snapshot does not track current Irisy acceptance or defects. Current Irisy decisions live in ADR-005, with substrate behavior owned by ADR-002.

# Irisy 能力历史实测问题清单 (2026-06-19)
