...
> **Status: Retired historical record.** Non-authoritative; this document neither governs current work nor tracks active acceptance. Current communication decisions live in ADR-010, with substrate implementation boundaries in ADR-002.
