> **Status: Retired historical record.** Non-authoritative; this capability inventory is provenance, not the current module spec. Current smart-table decisions live in ADR-002 and ADR-003.

# 智能表格 — 历史能力清单 (参考飞书多维表格)
