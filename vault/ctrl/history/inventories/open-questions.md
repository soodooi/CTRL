> **Status: Retired historical record.** Non-authoritative; this checklist is not the current work queue. Read `vault/ctrl/GOAL.md` and the owning ADRs for active work and open decisions.

# 历史待解决清单 (Open Questions)

> 这是已退役的「未解决」清单快照；不再更新。
