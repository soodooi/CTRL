...
> **Status: Retired historical record.** Non-authoritative; this inventory is not an endpoint SSOT. Current endpoint and visibility decisions live in ADR-002 and ADR-010; generated counts live in `vault/ctrl/generated/endpoint-catalog.md`.
