---
title: Vault §8 manual smoke (historical)
kind: historical-runbook
status: retired
authority: vault/ctrl/adrs/002-substrate.md
---

> **Status: Retired historical runbook.** Non-authoritative; preserved only as provenance for the former Vault §8 v0.1.147 manual smoke. It is not current acceptance guidance. Current verification lives in the accepted ADR-002 acceptance criteria.

# Vault §8 — historical manual smoke test

<details>
<summary>Archived v0.1.147 procedure — do not use for current acceptance</summary>

ADR-002 substrate § vault v1 §8 shipped in v0.1.146+. This frozen document drove the former acceptance flow and is retained only as provenance.
