...
## 现状 (2026-06-18)
- 版本:0.1.273+（参考 [architecture-byo-cli-driver.md](architecture-byo-cli-driver.md)，最新架构基准）
...
- **brain 双路架构**: Irisy 路 = Hermes Agent（CTRL bundle + lazy-install），BYO-CLI 路 = 用户自带 CLI（Claude Code 等）经 projection 接入。两条路并存,都经 `:17873` gate → [architecture-byo-cli-driver](architecture-byo-cli-driver.md)

## 入口 (Map of Content)
- **架构基准** [`architecture-byo-cli-driver.md`](architecture-byo-cli-driver.md) — 当前权威架构（BYO-CLI driver platform + Hermes 双 brain 路）
