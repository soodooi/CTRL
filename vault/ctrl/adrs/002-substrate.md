...
sections:
  ...
  - { id: composition,          source: orig-024, note: "v73 §7: versioned draft-2020-12 JSON Schema is the sole cross-language manifest authority; TypeScript/Ajv and Rust/jsonschema are consumers, while product/install evals remain separate." }
