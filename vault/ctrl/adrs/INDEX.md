...
| [004](./004-cap.md) | cap | Mcp execution model + Tauri updater + 4-layer × 3-tier auto-update (**Layer 2 = external-agent tier, ACP probe + L3, §3 v2**) + **§1 OS sandbox on pack shell DRIFT closed (macOS sandbox-exec, v3)** + **§2 clean-source provenance, split secret/citation governance baselines, retry-safe updater pairing, stable macOS Designated Requirement, and fail-closed updater trust epochs/lost-key reinstall recovery (v8)** | v8 | accepted | 2026-07-24 |
