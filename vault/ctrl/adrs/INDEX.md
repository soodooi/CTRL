...
| [004](./004-cap.md) | cap | Mcp execution model + Tauri updater + 4-layer × 3-tier auto-update (**Layer 2 = external-agent tier, source-pinned ACP probe with isolated named-custom provider selection, §3 v10**) + **§1 OS sandbox on pack shell DRIFT closed (macOS sandbox-exec, v3)** + **§2 clean-source provenance, split secret/citation governance baselines, retry-safe updater pairing, fail-closed updater trust epochs, and governed macOS release-identity epochs with encrypted recovery (v9)** | v10 | accepted | 2026-07-24 |
...
| [006](./006-cross-cutting.md) | cross-cutting | **BYOK aggregator-first** + global English first + plain-text philosophy + policy envelope | v11 | accepted | 2026-07-02 |
