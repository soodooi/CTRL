...
| [004](./004-cap.md) | cap | Mcp execution model + Tauri updater + 4-layer × 3-tier auto-update (**Layer 2 = external-agent tier, ACP probe + L3, §3 v2**) + **§1 OS sandbox on pack shell DRIFT closed (macOS sandbox-exec, v3)** + **§2 clean-source provenance, retry-safe updater pairing, and stable macOS release Designated Requirement (v6)** | v6 | accepted | 2026-07-23 |
