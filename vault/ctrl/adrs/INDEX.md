...
| [004](./004-cap.md) | cap | Mcp execution model + Tauri updater + 4-layer × 3-tier auto-update (**Layer 2 = external-agent tier, ACP probe + L3, §3 v2**) + **§1 OS sandbox on pack shell DRIFT closed (macOS sandbox-exec, v3)** + **§2 clean-source provenance, split secret/citation governance baselines, retry-safe updater pairing, fail-closed updater trust epochs, and governed macOS release-identity epochs with encrypted recovery (v9)** | v9 | accepted | 2026-07-24 |
