...
| frontend | PWA shell, L1 nav, Keyboard, vault browser, viewers, macOS Accessory launcher/tray/window lifecycle | `packages/ctrl-web/` + `src-tauri/src/shell/{lifecycle,tray,window}.rs` + `src-tauri/src/lib.rs` |
