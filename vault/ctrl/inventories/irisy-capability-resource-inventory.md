---
title: Irisy 能力清单 + 资源清单（历史盘点）
kind: inventory
created_at: 2026-07-04
owner: bao
author: claude
purpose: 记录 2026-07-04 的工具与资源观测，作为规划输入；不是当前能力或架构权威。
...
> **非权威历史盘点（as of 2026-07-04）。** 数量和可达性会随实现变化；当前运行事实以代码、生成 endpoint catalog 和测试为准，架构决定以 ADR-002、ADR-005、ADR-010 的 owning sections 为准。
