...
- `.olym/decisions/005-irisy.md` §1 (lifecycle) / §3 (prompt v5) / §4 (SOUL.md)
- `.olym/decisions/002-substrate.md` §3 (brain) / §3.7 (brain_status)
- `.olym/brainstorm/irisy-capabilities-2026-06-04.md` (能力清单, 本 doc 是 A 类 brain-ops 的延伸)
- `.olym/brainstorm/user-intents-2026-06-04.md` (I 反 5 项, 本 doc 提供主动反思与之互补)
- `.olym/brainstorm/vault-irisy-product-design-2026-06-03.md` (vault 整体设计)
