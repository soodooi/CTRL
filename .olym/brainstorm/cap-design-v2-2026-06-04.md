...
| # | 文件 | 改动 |
|---|---|---|
| 14a | `.olym/decisions/002-substrate.md` | § keycap-source v1 → v2, 加第 6 源 `skill`, 加 view registration 规范 |
| 14b | `.olym/decisions/005-irisy.md` | 加 § normalize v1, 定义 Irisy 作为 cap manifest 写者的职责 + 启发式 |
| 14c | `.olym/decisions/007-workbench.md` | 加 § cap-table v1, 锁多维表为 workspace 默认页 + 字段类型 + 多视图切换 |
...
- ADR 待 amend: `.olym/decisions/002-substrate.md` § keycap-source v2, `.olym/decisions/005-irisy.md` § normalize v1, `.olym/decisions/007-workbench.md` § cap-table v1
