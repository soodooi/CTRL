...
| [005](./005-irisy.md) | irisy | **PWA persona shell** + sycophancy filter + system-prompt injection + drill-down; **v11 数字员工 operator** (§8 terminal-essence dialog + §9 mission + knowledge system) + **§2 remote co-view SHIPPED (v21) — semantic "remote window" (option B), relay-only + E2E + persistent device model (RustDesk/ToDesk parity) + hosted PWA app.ctrlapplab.com; pixel remote-desktop = ADR-010 ⑧, unbuilt** | v21 | accepted | 2026-07-07 |
