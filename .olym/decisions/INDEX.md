...
|---|---|---|---|---|---|---|
| [001](./001-system-architecture.md) | Adopt 4-layer AI-native Agent OS kernel architecture *(amend 2026-05-22: hermes-as-brain framing)* | accepted | 2026-05-11 | bao, zeus | framework | — |
| [002](./002-pwa-pivot.md) | Pivot UI to single PWA codebase under thin Tauri 2 native shell *(amend 2026-05-22: 2-zone workbench, non-chat-app, 10-type renderer)* | accepted | 2026-05-13 | bao, zeus | framework | — |
