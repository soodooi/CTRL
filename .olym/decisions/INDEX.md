...
| [002](./002-substrate.md) | substrate | **BYO-CLI driver brain (§1, v27) + § projection (§1B, v27 core: assets→CLI native config) + ACP demoted to future (§1.8)** · Obsidian notes (§1.9) · capability surface · 3-capability-face · provider router · crypto · subprocess · MCP bus (= projection gate) · composition | v27 | accepted | 2026-06-17 |
