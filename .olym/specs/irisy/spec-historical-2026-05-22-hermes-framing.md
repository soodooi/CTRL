---
ARCHIVED: 2026-05-26
ARCHIVED_REASON: Superseded by ADR-001 1st 校准 (Pi-as-sole-brain) on 2026-05-25. Hermes-as-brain framing throughout this spec is no longer authoritative. Preserved for design-thinking reference (8-stage lifecycle / surface decomposition / persona principles still partially relevant). Current authority = .olym/specs/irisy/spec.md (new module entry).
type: spec-historical
spec_id: irisy
status: alpha
version: 0.2.0
owner: hephaestus
